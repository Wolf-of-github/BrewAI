#!/usr/bin/env bash
# Build, push, and deploy the resume-parser-service to Cloud Run.
# Run from the infra/ directory: ./deploy-resume-parser.sh [image-tag]
set -euo pipefail
...
echo "==> Done. Resume parser service deployed with tag=${TAG}"
