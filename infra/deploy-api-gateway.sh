#!/usr/bin/env bash
# Build, push, and deploy the api-gateway-service to Cloud Run.
# Run from the infra/ directory: ./deploy-api-gateway.sh [image-tag]
set -euo pipefail
...
echo "==> Done. API Gateway service deployed with tag=${TAG}"
